...
class TestValidation:
    ...
    def test_validate_range(self):
        ...
        with pytest.raises(
            ValueError, match="min_val must be less than or equal to max_val"
        ):
    ...
    def test_validate_boundary_conditions(self):
        ...
        valid_bcs = {
            "bc1": {"type": "dirichlet", "boundary": 1, "value": 0.0},
            "bc2": {"type": "neumann", "boundary": 2, "value": 1.0},
        }
        ...
        invalid_type_bcs = {
            "bc1": {"type": "invalid_type", "boundary": 1, "value": 0.0}
        }
...
class TestManufacturedSolutions:
    ...
    def test_polynomial_solution(self):
        ...
        solution = PolynomialSolution(
            dimension=2, degree=2, coefficients=[1.0, 2.0, 3.0]
        )
    ...
    def test_manufactured_solution_errors(self):
        ...
        with pytest.raises(ValueError, match="Unsupported solution type"):
            generate_manufactured_solution(solution_type="invalid_type", dimension=2)
    ...
    def test_validation_error_handling_integration(self):
        ...
        def validate_with_error_handling(value, param_name):
            try:
                ...
                handler.log_error(
                    ErrorLevel.ERROR, str(e), {"parameter": param_name, "value": value}
                )
                return False
