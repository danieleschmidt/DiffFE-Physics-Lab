...
from src.performance.cache import CacheManager, LRUCache, cached
from src.performance.monitor import (
    AlertLevel,
    ApplicationMetrics,
    PerformanceMonitor,
    SystemMetrics,
)
from src.performance.optimizer import OptimizationConfig, PerformanceOptimizer
...
class TestPerformanceProfiler:
    ...
    def test_profiler_init(self):
        ...
        profiler = PerformanceProfiler(
            enable_memory_profiling=True, enable_stack_trace=False
        )
...
class TestPerformanceOptimizer:
    ...
    def test_optimizer_init(self):
        ...
        config = OptimizationConfig(max_threads=4, max_processes=2, batch_size=50)
...
class TestPerformanceMonitor:
    ...
    def test_monitor_init(self):
        ...
        monitor = PerformanceMonitor(
            monitoring_interval=2.0, history_size=1000, enable_system_monitoring=True
        )
...
class TestPerformanceErrors:
    ...
    def test_optimizer_resource_limits(self):
        ...
        config = OptimizationConfig(
            max_threads=1, max_processes=1, memory_limit_mb=10.0  # Very low limit
        )
