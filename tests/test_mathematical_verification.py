...
from src.utils.manufactured_solutions import (
    ...
    laplace_manufactured_solution, compute_source_term
)
...
class TestManufacturedSolutions:
    ...
    def test_laplace_manufactured_solution(self):
        ...
        h = 1e-4
        u_xx = (laplace_manufactured_solution(x+h, y)[0] - 
                2*u + 
                laplace_manufactured_solution(x-h, y)[0]) / h**2
        u_yy = (laplace_manufactured_solution(x, y+h)[0] - 
                2*u + 
                laplace_manufactured_solution(x, y-h)[0]) / h**2
