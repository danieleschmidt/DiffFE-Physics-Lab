...
class Translator:
    ...
    def translate(self, key: str, **kwargs) -> str:
        ...
        logger.warning(f"Translation not found for key '{key}' in {self.current_language.value}")
        return key
    ...
    def add_custom_translations(self, language: Language, translations: Dict[str, str]):
        ...
        logger.info(f"Added {len(translations)} custom translations for {language.value}")
