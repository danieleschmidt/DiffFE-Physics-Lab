...
class OptimizationService:
    ...
    def minimize_scalar(
        ...
        opt_result = OptimizationResult(
            ...
            function_evaluations=result.nfev if hasattr(result, 'nfev') else eval_count[0],
    ...
    def _optimize_with_scipy(
        ...
        try:
            ...
            if method not in [OptimizationMethod.NELDER_MEAD, OptimizationMethod.DIFFERENTIAL_EVOLUTION]:
        ...
        opt_result = OptimizationResult(
            ...
            function_evaluations=result.nfev if hasattr(result, 'nfev') else eval_counts['func'],
            gradient_evaluations=result.njev if hasattr(result, 'njev') else eval_counts['grad'],
        ...
        self.best_result = opt_result
        logger.info(f"Vector optimization completed: f*={opt_result.optimal_value:.6e}, "
    ...
    def _optimize_with_backend(
        ...
        optimal_params = {name: val for name, val in zip(param_names, optimal_params_np)}
        ...
        self.best_result = opt_result
        logger.info(f"Backend optimization completed: f*={opt_result.optimal_value:.6e}")
    ...
    def multi_start_optimization(
        ...
        if results:
            ...
            logger.info(f"Multi-start optimization completed. "
