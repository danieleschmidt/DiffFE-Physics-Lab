...
class NavierStokesOperator(NonlinearOperator):
    ...
    **kwargs
    ...
    def linearize(
        self, solution: Any, params: Dict[str, Any] = None
        ...
        return LinearizedNavierStokes(
            background_velocity=solution, nu=self.nu, steady=self.steady, **params or {}
        )
...
def navier_stokes(
    trial: Any, test: Any, nu=1.0, body_force=None, steady=True, **kwargs
) -> Any:
...
def incompressibility(velocity_trial: Any, pressure_test: Any, **kwargs) -> Any:
